...
export const metadata: Metadata = {
  title: "Email Tracker — Ayaz's Dashboard",
  description: "Track email opens in real-time with a clean, modern dashboard",
};
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              ...
              <nav className="flex items-center gap-2">
                <Link
                  href="/"
                  className="px-4 py-2 text-sm text-gray-300 hover:text-white hover:bg-gray-800 rounded-lg transition-all duration-200"
                >
                  Dashboard
                </Link>
                <Link
